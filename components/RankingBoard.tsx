                  ...
                  >
                    {Array.from({ length: 35 }, (_, i) => {
                      ...
                      if (w === 1) start = startSchool;
                        ...
                        // This is a bit approximate but good for the label
                        // We need to account for the 2-week shift
                        let weeksToAdd = w - 2;
                        if (w >= 18) weeksToAdd += 1; // Adjust for the 05/01 shift
                        if (w >= 24) weeksToAdd += 1; // Adjust for Tết
